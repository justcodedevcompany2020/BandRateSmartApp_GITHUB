...
export default class App extends Component {
    ...
    getAllBasketProducts  = async () => {
        ...
        fetch(
            'http://37.230.116.113/BandRate-Smart/public/api/AllShoppingBasket',
            {
                method: "GET",
                headers: {
                    'Authorization': AuthStr,
    ...
    addProductCount = async (basket_product) => {
        ...
        if (this.state.count_request === true ) {
            ...
            // console.log(userToken, "token")
            fetch(
                'http://37.230.116.113/BandRate-Smart/public/api/CreateShoppingBasket',
                {
                    method: "POST",
                    headers: {
                        'Authorization': AuthStr,
    ...
    deleteProductCount = async (basket_product) => {
        ...
        if (this.state.count_request === true ) {
            ...
            // console.log(userToken, "token")
            fetch(
                'http://37.230.116.113/BandRate-Smart/public/api/DeleteShoppingBasket',
                {
                    method: "POST",
                    headers: {
                        'Authorization': AuthStr,
    ...
    deleteBasketProduct = async (basket_product) => {
        ...
        // console.log(userToken, "token")
        fetch(
            'http://37.230.116.113/BandRate-Smart/public/api/DeleteProductBasket',
            {
                method: "POST",
                headers: {
                    'Authorization': AuthStr,
    ...
    payInCashMethod = async () => {
        ...
        if (name == ""  || city == "" || street == "" || house == "" || phone == ""  || sort_by_default === false) {
            ...
            // console.log(userToken, "token")
            fetch(
                'http://37.230.116.113/BandRate-Smart/public/api/CreateOrder',
                {
                    method: "POST",
                    headers: {
                        'Authorization': AuthStr,
