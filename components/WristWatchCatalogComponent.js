...
export default class App extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            all_additional_functions_array: [
                ...
                'компас',
                'коррекция часов по радиосигналу',
                'мировое время',
                'отливы и приливы',
    ...
    //
    //     await AsyncStorage.getItem('filterInfoWristWatch',(err,item) => {
    //
    ...
    //
    //
    //             console.log(filterInfo, 'filterInfoWristWatch')
    //
    //         //
    ...
    //         //     }
    //         //
    //         //     if (filterInfo.hasOwnProperty("Backlight")) {
    //         //         this.setState({
    //         //             sort_by_backlight: filterInfo.Backlight
    //         //         })
    //         //     }
    //         //
    //         //
    ...
    //         //     //     })
    //         //     // }
    //         //     if (filterInfo.hasOwnProperty("Additional_functions")) {
    //         //         this.setState({
    //         //             sort_by_additional_functions: filterInfo.Additional_functions
    //         //         })
    //         //     }
    //         //
    ...
    useFilter = async () => {
        ...
        let { minPrice, maxPrice, sort_by_gender, sort_by_backlight, sort_by_mechanism, sort_by_frame, sort_by_bracelet, sort_by_additional_functions, sort_by_waterproof, sort_by_glass, sort_by_calendar, sort_by_guarantee, sort_by_equipment, sort_by_brend} = this.state
        let filterData = {};
        ...
        if (sort_by_gender.length > 0){

            let gender = "";
            filter_info.gender = sort_by_gender;

            if (sort_by_gender.length == 1 ) {
                gender = sort_by_gender[0];
            } else {
                gender = sort_by_gender.join("^");
            }
        ...
        if (sort_by_brend.length > 0){

            let brend = "";
            filter_info.vendor = sort_by_brend;

            if (sort_by_brend.length == 1 ) {
                brend = sort_by_brend[0];
            } else {
                brend = sort_by_brend.join("^");
            }

            filterData.vendor = brend;

        }


        if (sort_by_mechanism.length > 0 ){

            let mechanism = "";
            filter_info.Mechanism = sort_by_mechanism;

            if (sort_by_mechanism.length == 1 ) {
                mechanism = sort_by_mechanism[0];
            } else {
                mechanism = sort_by_mechanism.join("^");
            }

            filterData.Mechanism = mechanism;
        ...
        if (sort_by_backlight.length > 0 ){

            let backlight = "";
            filter_info.Backlight = sort_by_backlight;

            if (sort_by_backlight.length == 1 ) {
                backlight = sort_by_backlight[0];
            } else {
                backlight = sort_by_backlight.join("^");
            }

            filterData.Backlight = backlight;
        ...
        fetch(
            ...
            .then((response) => {
                ...
                console.log(response.data, "response.filterCleverClock");
                // return false
                ...
                AsyncStorage.setItem('filterInfoWristWatch', JSON.stringify(filter_info) );
    ...
    checkSavedFilter = async () => {
        ...
        await AsyncStorage.getItem('filterInfoWristWatch',(err,item) => {
            ...
            if (Object.keys(filterInfo).length === 0) {
                ...
                if (filterInfo.hasOwnProperty("vendor")) {
                    this.setState({
                        sort_by_brend: filterInfo.vendor
                    })
                }
    ...
    clearFilter = async () => {
        ...
        await AsyncStorage.removeItem('filterInfoWristWatch');
    ...
    redirectToCardProduct = (item) => {
        this.props.navigation.navigate("CardProduct", {
            ...
            params2: 'WristWatchCatalogComponent'
        });
    }
                                ...
                                <ScrollView  style={styles.filter_modal_inputs_main_wrapper} nestedScrollEnabled = {true}>
                                    ...
                                    <TouchableWithoutFeedback>
                                        <View style={styles.sort_radio_input}>
                                            ...
                                            {/*Пол start*/}
                                                ...
                                                <View style={styles.sort_radio_input}>
                                                    ...
                                                    <ScrollView style={styles.sort_radio_input_child_scroll} horizontal={true}>
                                                        ...
                                                        {this.state.all_gender_array.map((item, index) => {

                                                            return (
                                                                <TouchableOpacity
                                                                    key={index}
                                                                    style={[styles.inputRadio, this.state.sort_by_gender.includes( item) ? styles.activeInputRadioBorder : {}, {marginRight: 15}]}
                                                                    onPress={()=> {

                                                                        if(this.state.sort_by_gender.includes( item)) {

                                                                            let sort_by_gender = this.removeFromArray(this.state.sort_by_gender, item);
                                                                            this.setState({
                                                                                sort_by_gender: sort_by_gender
                                                                            });

                                                                        } else {
                                                                            let sort_by_gender = this.state.sort_by_gender;

                                                                            sort_by_gender.push(item)
                                                                            this.setState({
                                                                                sort_by_gender: sort_by_gender
                                                                            })
                                                                        }
                                                                ...
                                                                >
                                                                    <Text style={[styles.sort_radio_input_title, this.state.sort_by_gender.includes( item) ? styles.activeInputRadioColor : {}]}>{item}</Text>
                                                                </TouchableOpacity>
                                            ...
                                            <View style={styles.sort_radio_input}>
                                                <Text style={styles.sort_radio_input_main_title}>Бренд</Text>

                                                {/*<ScrollView style={styles.sort_radio_input_child}>*/}
                                                <ScrollView style={styles.sort_radio_input_child_scroll} horizontal={true}>


                                                    {this.state.all_brend_array.map((item, index) => {

                                                        return (
                                                            <TouchableOpacity
                                                                key={index}
                                                                style={[styles.inputRadio, this.state.sort_by_brend.includes( item) ? styles.activeInputRadioBorder : {}, {marginRight: 15}]}
                                                                onPress={()=> {

                                                                    if(this.state.sort_by_brend.includes( item)) {

                                                                        let sort_by_brend = this.removeFromArray(this.state.sort_by_brend, item);
                                                                        this.setState({
                                                                            sort_by_brend: sort_by_brend
                                                                        });

                                                                    } else {
                                                                        let sort_by_brend = this.state.sort_by_brend;

                                                                        sort_by_brend.push(item)
                                                                        this.setState({
                                                                            sort_by_brend: sort_by_brend
                                                                        })
                                                                    }
                                                            ...
                                                            >
                                                                <Text style={[styles.sort_radio_input_title, this.state.sort_by_brend.includes( item) ? styles.activeInputRadioColor : {}]}>{item}</Text>
                                                            </TouchableOpacity>
                                            ...
                                            {/*Механизм start*/}
                                                ...
                                                <View style={styles.sort_radio_input}>
                                                    ...
                                                    <ScrollView style={styles.sort_radio_input_child_scroll} horizontal={true}>
                                                        ...
                                                        {this.state.all_mechanism_array.map((item, index) => {

                                                            return (
                                                                <TouchableOpacity
                                                                    key={index}
                                                                    style={[styles.inputRadio, this.state.sort_by_mechanism.includes( item) ? styles.activeInputRadioBorder : {}, {marginRight: 15}]}
                                                                    onPress={()=> {

                                                                        if(this.state.sort_by_mechanism.includes( item)) {

                                                                            let sort_by_mechanism = this.removeFromArray(this.state.sort_by_mechanism, item);
                                                                            this.setState({
                                                                                sort_by_mechanism: sort_by_mechanism
                                                                            });

                                                                        } else {
                                                                            let sort_by_mechanism = this.state.sort_by_mechanism;

                                                                            sort_by_mechanism.push(item)
                                                                            this.setState({
                                                                                sort_by_mechanism: sort_by_mechanism
                                                                            })
                                                                        }
                                                                ...
                                                                >
                                                                    <Text style={[styles.sort_radio_input_title, this.state.sort_by_mechanism.includes( item) ? styles.activeInputRadioColor : {}]}>{item}</Text>
                                                                </TouchableOpacity>
                                            ...
                                            {/*Подсветка start*/}
                                                ...
                                                <View style={[styles.sort_radio_input, {paddingBottom: 0}]}>
                                                    <Text style={styles.sort_radio_input_main_title}>Подсветка</Text>
                                                    <ScrollView style={styles.sort_radio_input_child_scroll} horizontal={true}>


                                                        {this.state.all_backlight_array.map((item, index) => {

                                                            return (
                                                                <TouchableOpacity
                                                                    key={index}
                                                                    style={[styles.inputRadio, this.state.sort_by_backlight .includes( item) ? styles.activeInputRadioBorder : {}, {marginRight: 15}]}
                                                                    onPress={()=> {

                                                                        if(this.state.sort_by_backlight.includes( item)) {

                                                                            let sort_by_backlight = this.removeFromArray(this.state.sort_by_backlight, item);
                                                                            this.setState({
                                                                                sort_by_backlight: sort_by_backlight
                                                                            })
                                                                        } else {
                                                                            let sort_by_backlight = this.state.sort_by_backlight;

                                                                            sort_by_backlight.push(item)
                                                                            this.setState({
                                                                                sort_by_backlight: sort_by_backlight
                                                                            })
                                                                        }
                                                                ...
                                                                >
                                                                    <Text style={[styles.sort_radio_input_title, this.state.sort_by_backlight.includes( item) ? styles.activeInputRadioColor : {}]}>{item}</Text>
                                                                </TouchableOpacity>
                                                ...
                                                <ScrollView style={styles.sort_radio_input_child_scroll} horizontal={true}>
                                                    ...
                                                    {this.state.all_additional_functions_array.map((item, index) => {
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                <Text style={[styles.sort_radio_input_title, this.state.sort_by_additional_functions.includes( item) ? styles.activeInputRadioColor : {}]}>{item}</Text>
                                                            </TouchableOpacity>
        ...
        return (
            <SafeAreaView style={styles.container} >
                ...
                <View style={styles.catalog_header}>
                    <Text style={styles.catalog_title}>Наручные</Text>
                    <TouchableOpacity style={styles.catalog_menu_icon}  onPress={() => this.setState({showFilterModal: true})}>
                        {/*<Svg*/}
                        {/*    xmlns="http://www.w3.org/2000/svg"*/}
                        {/*    width={30}*/}
                        {/*    height={18}*/}
