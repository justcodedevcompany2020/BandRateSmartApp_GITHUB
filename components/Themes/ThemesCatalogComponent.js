...
export default class App extends Component {
    ...
    getCatalogData = async () => {
        ...
        fetch(
            'http://37.230.116.113/BandRate-Smart/public/api/get_themes?page='+current_paginate,
            {
                method: "GET",
                headers: {
                    'Authorization': AuthStr,
        ...
        .then((response) => {
            ...
            // return false
            this.setState({
                themes_items: response.data.data,
                loaded: true,
    ...
    redirectToCardProduct = (item) => {
        this.props.navigation.navigate("ThemeSingleComponent", {
            theme: JSON.stringify(item),
        });
    }
    ...
    render() {
        ...
        return (
            <SafeAreaView style={styles.container} >
                ...
                {this.state.themes_items.length > 0 &&

                    <FlatList
                        style={styles.catalog_items_main_wrapper}
                        data={this.state.themes_items}
                        renderItem={({item}) => (
                            ...
                            <View style={styles.catalog_item}>
                                ...
                                <TouchableOpacity
                                    ...
                                    onPress={() => {
                                        this.redirectToCardProduct(item)
                                    }}
                                >
                                    <Image
                                ...
                                <View style={styles.catalog_item_info_wrapper}>
                                    <Text style={styles.theme_item_info_name}>{item.title}</Text>
                                </View>
